...
{
    public static GazeHand instance;
            ...
            */
            ...
            do
            {
                if (raycastHits[index].collider.gameObject.CompareTag("User")                  // 사용자 손은 인식 X
                    || raycastHits[index].collider.gameObject.CompareTag("HandTrigger")
                    || raycastHits[index].collider.gameObject.CompareTag("OptionTrigger")
            ...
            else                                // raycasted
            {
                ...
                if (raycastHits[index].collider.gameObject.CompareTag("Untagged")){
                ...
                gazedObject = lastCollider.gameObject;
            }
