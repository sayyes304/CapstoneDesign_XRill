...
public class PeerConnectionSample2 : MonoBehaviour
{
...
#pragma warning restore 0649
    ...
    private void OnStart()
    {
        ...
        if (videoStream == null)
        {
           ...
           // stream.AddTrack(new VideoStreamTrack(texture.monitor.texture));
            videoStream = stream;
           
        }

        //sourceImage.texture = texture.monitor.texture;
